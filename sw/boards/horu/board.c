  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /* PTA3*/ PAL_MODE_ALTERNATIVE_7,   /* PTA4*/ PAL_MODE_ALTERNATIVE_1,   /* PTA5*/ PAL_MODE_ALTERNATIVE_1,
        ...
        /*PTA12*/ PAL_MODE_ALTERNATIVE_1,   /*PTA13*/ PAL_MODE_ALTERNATIVE_1,   /*PTA14*/ PAL_MODE_ALTERNATIVE_1,
    ...
    {
      .port = IOPORT3,  // PORTC: CON[1:16]
      .pads = {
        /* PTC0*/ PAL_MODE_ALTERNATIVE_1,   /* PTC1*/ PAL_MODE_ALTERNATIVE_1,   /* PTC2*/ PAL_MODE_ALTERNATIVE_1,
        /* PTC3*/ PAL_MODE_ALTERNATIVE_1,   /* PTC4*/ PAL_MODE_ALTERNATIVE_1,   /* PTC5*/ PAL_MODE_ALTERNATIVE_1,
        /* PTC6*/ PAL_MODE_ALTERNATIVE_1,   /* PTC7*/ PAL_MODE_ALTERNATIVE_1,   /* PTC8*/ PAL_MODE_ALTERNATIVE_1,
        /* PTC9*/ PAL_MODE_ALTERNATIVE_1,   /*PTC10*/ PAL_MODE_ALTERNATIVE_1,   /*PTC11*/ PAL_MODE_ALTERNATIVE_1,
        /*PTC12*/ PAL_MODE_ALTERNATIVE_1,   /*PTC13*/ PAL_MODE_ALTERNATIVE_1,   /*PTC14*/ PAL_MODE_UNCONNECTED,
        /*PTC15*/ PAL_MODE_UNCONNECTED,     /*PTC16*/ PAL_MODE_ALTERNATIVE_1,   /*PTC17*/ PAL_MODE_ALTERNATIVE_1,
    ...
    {
      .port = IOPORT4,  // PORTD: CON[17:24]
      .pads = {
        /* PTD0*/ PAL_MODE_ALTERNATIVE_1,   /* PTD1*/ PAL_MODE_ALTERNATIVE_1,   /* PTD2*/ PAL_MODE_ALTERNATIVE_1,
        /* PTD3*/ PAL_MODE_ALTERNATIVE_1,   /* PTD4*/ PAL_MODE_ALTERNATIVE_1,   /* PTD5*/ PAL_MODE_ALTERNATIVE_1,
        /* PTD6*/ PAL_MODE_ALTERNATIVE_1,   /* PTD7*/ PAL_MODE_ALTERNATIVE_1,   /* PTD8*/ PAL_MODE_UNCONNECTED,
    ...
    {
      .port = IOPORT5,  // PORTE: CON[25:30]
      .pads = {
        /* PTE0*/ PAL_MODE_ALTERNATIVE_1,   /* PTE1*/ PAL_MODE_ALTERNATIVE_1,   /* PTE2*/ PAL_MODE_ALTERNATIVE_1,
        /* PTE3*/ PAL_MODE_ALTERNATIVE_1,   /* PTE4*/ PAL_MODE_ALTERNATIVE_1,   /* PTE5*/ PAL_MODE_ALTERNATIVE_1,
